            ...
            <div class="relative z-10 w-full flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div class="flex flex-col gap-1 text-center md:text-left text-white">
                    ...
                    <p class="text-sm opacity-80 font-medium">
                        {{ now()->translatedFormat('l, ngày d tháng m năm Y') }} • Chúc bạn một ngày làm việc hiệu quả.
                    </p>
                </div>

                <!-- Live Metrics Segment -->
                <div class="flex items-center gap-4">
                    <div
                        class="px-4 py-3 rounded-xl bg-white/10 backdrop-blur-md border border-white/10 flex flex-col items-end min-w-[120px]">
                    ...
                    <div
                        class="px-4 py-3 rounded-xl bg-white/10 backdrop-blur-md border border-white/10 flex flex-col items-end min-w-[120px]">
                        <span class="text-[10px] font-bold uppercase tracking-wider text-white/60 mb-1">Shipper
                            Online</span>
